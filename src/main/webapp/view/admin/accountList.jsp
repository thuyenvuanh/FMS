    ...
    <div class="ibox-content m-b-sm border-bottom">
        <form>
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="col-form-label" for="select_role">Role</label>
                ...
                <div class="container-fluid">
                    <button class="btn btn-outline-success  float-right" type="submit"
                            formaction="<c:url value="/account/search"/>">Search
                    </button>
                </div>
            </div>
        </form>
...
<c:if test="${sessionScope.createStatus != null}">
    <c:if test="${sessionScope.createStatus == 'success'}">
        <script>
    ...
    <c:if test="${sessionScope.createStatus == 'fail'}">
        <script>
            $(document).ready(function () {
                swal({
                    title: "Create Failed!",
