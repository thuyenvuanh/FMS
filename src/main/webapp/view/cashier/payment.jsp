      ...
      <div class="h-75 rounded-3 shadow-lg" style="width: 40%;">
        <form method="post" class="row gx-2 px-2 pt-2" style="height: 20%;">
          ...
          <div class="col-4 h-100" style="height: 33.3333%;">
              <button type="submit" formaction="<c:url value="/payment/create"/>" class="btn btn-success h-100 w-100 fs-1 fw-bold">PAY</button>
          </div>
        </form>
        <div class="mx-2 gx-2" style="height: 80%;">
          <div class="row h-25 px-2">
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('7')"  class="btn btn-success h-100 w-100 fs-1 fw-bold">7</button>
            </div>
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('8')" class="btn btn-success h-100 w-100 fs-1 fw-bold">8</button>
            </div>
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('9')" class="btn btn-success h-100 w-100 fs-1 fw-bold">9</button>
            </div>
          </div>
          <div class="row h-25 px-2">
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('4')" accesskey="4" class="btn btn-success h-100 w-100 fs-1 fw-bold">4</button>
            </div>
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('5')" class="btn btn-success h-100 w-100 fs-1 fw-bold">5</button>
            </div>
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('6')" class="btn btn-success h-100 w-100 fs-1 fw-bold">6</button>
            </div>
          </div>
          <div class="row h-25 px-2">
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('1')" class="btn btn-success h-100 w-100 fs-1 fw-bold">1</button>
            </div>
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('2')" class="btn btn-success h-100 w-100 fs-1 fw-bold">2</button>
            </div>
            <div class="col-4 px-1 pt-2">
              <button type="submit" onclick="dis('3')" class="btn btn-success h-100 w-100 fs-1 fw-bold">3</button>
            </div>
          </div>
          <div class="row h-25 px-2">
            <div class="col-4 px-1 py-2">
              <button type="submit" onclick="clr()" class="btn btn-success h-100 w-100 fs-1 fw-bold">CLR</button>
            </div>
            <div class="col-4 px-1 py-2">
              <button type="submit" onclick="dis('0')" class="btn btn-success h-100 w-100 fs-1 fw-bold">0</button>
            </div>
            <div class="col-4 px-1 py-2">
              <button type="submit" onclick="dis('.')" disabled class="btn btn-success h-100 w-100 fs-1 fw-bold">.</button>
            </div>
          </div>
        </div>
      </div>
